...
export default function Footer() {
  return (
    <section id="footer">
        <div className="container my-5">
            <div className="row  ">
                ...
                <ul className='d-block list-unstyled d-flex flex-column ' >
                  <li><a href="/" className="service-a"><span><i className="bi bi-arrow-right-short text-primary pe-1"></i></span>Web Design</a></li>
                  <li><a href="/" className="service-a"><span><i className="bi bi-arrow-right-short text-primary pe-1"></i></span>Web Development</a></li>
                  <li><a href="/" className="service-a"><span><i className="bi bi-arrow-right-short text-primary pe-1"></i></span>Graphic Design</a></li>
                  <li><a href="/" className="service-a"><span><i className="bi bi-arrow-right-short text-primary pe-1"></i></span>UI/UX Design</a></li>
                </ul>
                </div>
                <div className="col-md-4  animate__animated animate__fadeInUp">
                ...
                <ul className='d-block list-unstyled  ps-2' >
                  <li className='d-flex mb-2'>
                   <i className=" icon bi bi-map-fill text-primary"></i>
                    <div className='info ms-2'>203 Fake St. Mountain View, San Francisco, California, USA</div>
                  </li>
                  <li className='d-flex mb-2'>
                    <i className="icon bi bi-telephone-fill text-primary"></i>
                  <div className='info '>+2 392 3929 210</div>
                  </li>
                  <li className='d-flex mb-2'>
                    <i className=" icon bi bi-send-fill text-primary"></i>
                    <div className='info '>info@yourdomain.com</div>
                  </li>
                </ul>
                </div>
            </div>
        ...
        <hr />
        <div className="container-fluid text-center p-4 animate__animated animate__fadeInUp">
